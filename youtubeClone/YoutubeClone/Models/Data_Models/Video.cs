...
namespace YoutubeClone.Models.Data_Models {
    ...
    public class Video
    {
        ...
        [Required, MinLength(5), MaxLength(40), DisplayName("Entrez le nom de la video")]
        public string Name { get; set; }
        [Required,  MaxLength(180), DisplayName("Entrez une description")]
        [RegularExpression(@"(\S*\s){2,}(\S+){1}")]
        public string Description { get; set; }
        [Required, DisplayName("Choisissez la categorie")]
